                            ...
                            <div className="flex flex-col gap-6 p-5 sm:p-7 lg:flex-row lg:items-center lg:justify-between">
                                <div className="max-w-2xl">
                                    ...
                                    <h1 className="mt-4 text-2xl font-bold sm:text-3xl">
                                        Find surplus crops for your next
                                        production need.
                                    </h1>
                                    <p className="mt-3 max-w-xl text-sm leading-6 text-white/80 sm:text-base">
                                        Post the agri resources you are looking
                                        for and prepare to match with available
                                        farmer surplus at practical prices.
                                    </p>
                                </div>
                        ...
                        <div className="grid gap-4 lg:grid-cols-[1.25fr_0.75fr]">
                            <section className="rounded-xl border border-stone-200 bg-white p-5 shadow-sm sm:p-6">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-stone-500">
                                            ...
                                            once the posting module is added.
                                        </p>
                                    </div>
                                ...
                                <div className="mt-6 flex min-h-44 flex-col items-center justify-center rounded-xl border border-dashed border-[#6ab225]/35 bg-[#f7fbf3] px-4 py-8 text-center">
                                    ...
                                    <p className="mt-2 max-w-md text-sm leading-6 text-stone-500">
                                        ...
                                        target price, and remarks when the form
                                        is ready.
                                    </p>
                                </div>
                            </section>
                            ...
                            <aside className="rounded-xl border border-[#f2bd11]/40 bg-white p-5 shadow-sm sm:p-6">
                                ...
                                <p className="mt-2 text-sm leading-6 text-stone-500">
                                    Build the "I'm looking for" form so
                                    processors can post demand listings for
                                    surplus crops.
                                </p>
                                ...
                                <div className="mt-5 rounded-xl bg-[#f2bd11]/15 p-4">
                                    ...
                                    <p className="mt-2 text-sm leading-6 text-stone-600">
                                        Agri resource, quantity, price, and
                                        remarks.
                                    </p>
                                </div>
                            </aside>
